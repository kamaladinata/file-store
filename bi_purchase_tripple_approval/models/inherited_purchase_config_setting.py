...
class ResConfigSettings(models.TransientModel):
	...
	second_approval = fields.Boolean(string="Second Approval" ,related="company_id.second_approval")
	second_approval_minimum_amount = fields.Monetary(srting ="Minimum Amount",related="company_id.second_approval_minimum_amount")
