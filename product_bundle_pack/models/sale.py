...
class SaleOrderLine(models.Model):
    ...
    def _prepare_procurement_values(self, group_id):
        ...
        values = []
        date_planned = datetime.strptime(str(self.order_id.confirmation_date),
                                         DEFAULT_SERVER_DATETIME_FORMAT) + \
            timedelta(days=self.order_id.commitment_date or 0.0) - \
        ...
        if self.product_id.is_pack and self.product_id.pack_ids:
            ...
            res.update({
                ...
                'partner_dest_id': self.order_id.partner_shipping_id and
    ...
    def _compute_qty_delivered(self):
        self.ensure_one()
        line = super(SaleOrderLine, self)._compute_qty_delivered()
...
class StockRule(models.Model):
    ...
    def _get_stock_move_values(self, product_id, product_qty, product_uom,
        ...
        result = super(StockRule, self)._get_stock_move_values(product_id, product_qty,
