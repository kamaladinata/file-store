	...
	screens.ProductListWidget.include({
		init: function(parent, options) {
			...
			this.click_product_handler = function(){
				...
				{
					if (product.type == 'product' && product.to_make_mrp == false)
					{
					...
					if (product.type == 'product' && allow_order == false && product.to_make_mrp == false)
					{
					...
					else if(product.type == 'product' && allow_order == true && product.qty_available <= deny_order && product.to_make_mrp == false){
					self.gui.show_popup('error',{
							'title': _t('Error: Out of Stock'),
							'body': _t("(" + product.display_name + ")" + " is Out of Stock."),
						});
